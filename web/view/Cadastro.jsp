<%-- 
    Document   : Cadastro
    Created on : 24/04/2017, 18:30:15
    Author     : ramones
--%>
                        ...
                        <div class="panel panel-default text-center">
                          ...
                          <div class="panel-body">
                            <form action="cadastro" method="POST">
                                Nome: <input type="text" name="nomeCadastro"><br><br>
                                Email: <input type="email" name="emailCadastro"><br><br>
                                Senha: <input type="password" name="senhaCadastro"><br><br>
